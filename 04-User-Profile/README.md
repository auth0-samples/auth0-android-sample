...
This sample shows how to read and modify the logged in user profile.

A step by step [Quickstart Tutorial](https://auth0.com/docs/quickstart/native/android/04-user-profile) is provided in our site. If you prefer to skip it and run the sample make sure to [setup](#setup) the project first.
