 ...
 *   java quickstart/scripts/Configure.java AUTH0_DOMAIN AUTH0_CLIENT_ID AUTH0_SCHEME APPLICATION_ID
 *
 * Example:
 *   java quickstart/scripts/Configure.java dev-abc123.us.auth0.com aBcDeFgHiJkLmNoPqRsTuVwXyZ012345 https com.example.myapp
 */
class Configure {
    public static void main(String[] args) throws Exception {
        if (args.length != 4) {
            System.err.println("Usage: java Configure.java AUTH0_DOMAIN AUTH0_CLIENT_ID AUTH0_SCHEME APPLICATION_ID");
            System.exit(1);
        }
